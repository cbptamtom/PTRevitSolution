...
{
    public class CustomListBox : DependencyObject
    {
        ...
        public static void SetIsSubscribedToSelectionChanged(DependencyObject Rebar,
            bool value)
        {
            Rebar.SetValue(IsSubscribedToSelectionChangedProperty, value);
        }

        public static bool GetIsSubscribedToSelectionChanged(DependencyObject Rebar)
        {
            return (bool)Rebar.GetValue(IsSubscribedToSelectionChangedProperty);
        }
        ...
        public static void SetSelectedItems(DependencyObject Rebar, IList value)
        {
            Rebar.SetValue(SelectedItemsProperty, value);
        }

        public static IList GetSelectedItems(DependencyObject Rebar)
        {
            return (IList)Rebar.GetValue(SelectedItemsProperty);
        }
